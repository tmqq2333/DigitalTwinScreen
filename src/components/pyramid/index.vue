  ...
  <div class="wrap-container trigle">
    ...
    <div class="detail"
      ...
      <div class="detail_txt"
           :class="`detail_txt${index + 1}`">
        <span class="precent_txt"
              :class="`precent_txt${index + 1}`">
          <div class="chartsdom"
               :id="`chart_${index + 1}`"></div>
        </span>
        <div class="txt_right"
             :class="`txt_right${index + 1}`">
          <span>
            <div class="f_div"
                 :class="{aharrow_up: index == 0 || index == 1, aharrow_down: index == 2 || index == 3}">{{ item.post }}</div>
            <div class="s_div"
                 :class="`s_div${index + 1}`">{{ item.number }}人</div>
          </span>
        </div>
      </div>
      <div class="arrow_contain"
           :class="`arrow_contain${index + 1}`">
        <span class="arrow"
              :class="`arrow_${index + 1}`"></span>
      </div>
    </div>
